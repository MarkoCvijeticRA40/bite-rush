...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250415163034_Add_Product_Price_Table")]
    partial class Add_Product_Price_Table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Product.Product", b =>
                {
                    ...
                    b.Property<Guid>("ProductPriceId1")
                        .HasColumnType("uuid")
                        .HasColumnName("product_price_id1");
                    ...
                    b.HasIndex("ProductPriceId1")
                        .HasDatabaseName("ix_products_product_price_id1");
            ...
            modelBuilder.Entity("Domain.Product.Product", b =>
                {
                    b.HasOne("Domain.Products.ProductPrice", "ProductPrice")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_products_product_prices_product_price_id1");
